...
for col in ["Source Port", "Destination Port", "Protocol"]:
    if col in dfCombined.columns:
        ...
        dfCombined[col] = labelEncoder.fit_transform(dfCombined[col])
...
# Split dataset
featuresTrain, featuresTest, labelsTrain, labelsTest = train_test_split(features, labels, test_size=0.2, random_state=42, stratify=labels)
